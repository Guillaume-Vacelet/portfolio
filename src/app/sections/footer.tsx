...
export default function Footer() {
  return (
    <section id="footer" className="w-full p-[10px]">
      <div className="w-full flex flex-col justify-between gap-6 py-12 px-6 text-xs md:text-base font-medium bg-black rounded-md">
        <SocialLinks />
