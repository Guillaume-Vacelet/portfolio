...
export default function HomeSection() {
  return (
    <section id="home" className="section">
      <div className="overflow-hidden w-full gap-8 p-4 sm:p-10 sm:pt-7 bg-black shrink-animation dot-grid">

        <div className="relative size-full flex flex-col items-start justify-center">

          <div className="absolute top-0 right-0 fade-in-right">
            <LangDropdownList />
          </div>
